...
function buildToDo(todo, index) {
  ...
  toDoShell.className = "toDoShell"  //con el className asigno una clase al elemento creado anteriormente
  let toDoText = document.createElement("span"); 
  toDoText.innerHTML = todo.description; // Accedo al texto de mi elemento creado que seria igual al string que contiene la propiedad description de mi objeto toDo
